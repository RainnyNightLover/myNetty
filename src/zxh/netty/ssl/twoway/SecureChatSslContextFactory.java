...
public final class SecureChatSslContextFactory {
    ...
    /**
     * we had install the ca cert into the pk cert too
     *
     * @param pkPath
     * @param caPath
     * @return
    ...
    public static SSLContext getServerContext(String pkPath, String caPath) {
        ...
        try {
            ...
            if (pkPath != null) {
                ...
                keyManagerFactory.init(ks, "sNetty".toCharArray());
            }
            //信任库
    ...
    public static SSLContext getClientContext(String pkPath, String caPath) {
        ...
        try {
            ...
            if (pkPath != null) {
                ...
                keyManagerFactory = KeyManagerFactory.getInstance("SunX509");
                keyManagerFactory.init(ks, "cNetty".toCharArray());
            }
            ...
            //初始化此上下文
            //参数一：认证的密钥      参数二：对等信任认证  参数三：伪随机数生成器 。 由于单向认证，服务端不用验证客户端，所以第二个参数为null
            CLIENT_CONTEXT.init(keyManagerFactory.getKeyManagers(), trustManagerFactory.getTrustManagers(), null);
